                        ...
                        <Col>
                            <h2 className="Secondary-Title">Concevoir votre vie privée</h2>
                                ...
                                <div>
                                    ...
                                    <h4 className="para-bold">Dans le cadre de l'utilisation des Sites, l'Éditeur est susceptible de collecter les catégories de données
                                        suivantes concernant ses Utilisateurs :</h4>
                        
                                        <div className="text">Données d'état-civil, d'identité, d'identification... </div>
                            
                                        <div className="text">Données de connexion (adresses IP, journaux d'événements...) </div>
                                            
                                        <div className="text">Données de localisation (déplacements, données GPS, GSM...) </div>
                                </div>

                                <div>
                                    <h3 className="Third-Title">Communication des données personnelles à des tiers</h3>

                                    <h4 className="para-bold">Pas de communication à des tiers</h4>

                                        <div className="text">Vos données ne font l'objet d'aucune communication à des tiers. Vous êtes toutefois informés qu'elles pourront
                                ...
                                <div>
                                    ...
                                    <h4 className="para-bold">Information préalable et possibilité d’opt-out avant et après la fusion / acquisition</h4> 

                                        <div className="text">Dans le cas où nous prendrions part à une opération de fusion, d’acquisition ou à toute autre forme de cession
                                        d’actifs, nous nous engageons à garantir la confidentialité de vos données personnelles et à vous informer avant
                                        que celles-ci ne soient transférées ou soumises à de nouvelles règles de confidentialité.</div>
                                </div>

                                <div>
                                    <h3 className="Third-Title">Agrégation des données</h3>

                                    <h4 className="para-bold">Agrégation avec des données non personnelles</h4>
                                ...
                                <div>
                                    ...
                                    <h4 className="para-bold">Inscription et identification préalable pour la fourniture du service</h4>
                                ...
                                <div>
                                    ...
                                    <h4 className="para-bold">Utilisation de l'identifiant de l'utilisateur pour proposition de mise en relation et offres commerciales</h4>
                                ...
                                <div>
                                    ...
                                    <h4 className="para-bold">Géolocalisation à des fins de fourniture du service</h4>
                                    ...
                                    <h4 className="para-bold">Géolocalisation à des fins de croisement</h4>
                                 ...
                                 <div>
                                    ...
                                    <h4 className="para-bold">Aucune collecte des données techniques</h4>
                                ...
                                <div>
                                    ...
                                    <h4 className="para-bold">Durée de conservation des cookies</h4>
                                    ...
                                    <h4 className="para-bold">Finalité cookies</h4>
                                    ...
                                    <h4 className="para-bold">Droit de l'Utilisateur de refuser les cookies</h4>
                                ...
                                <div>
                                    ...
                                    <h4 className="para-bold">Durée de conservation des données techniques</h4>
                                 ...
                                 <div>
                                    ...
                                    <h4 className="para-bold">Durée de conservation des données techniquesConservation des données pendant la durée de la relation contractuelle</h4>
                                    ...
                                    <h4 className="para-bold">Conservation des données anonymisées au delà de la relation contractuelle / après la suppression du compte</h4>
